...
**Version 0.9.2 · Author: Glenn Jarzomkowski · License: MIT**
...
4. Verify: **View → Output → "IBM i Bridge"** — the first line must read
   `Bridge for IBM i v0.9.2 active.`
...
|---|---|
| Nothing happens on Ctrl+S | Is the first log line v0.9.2? Older versions lacked the save hook. |
...
**Version 0.9.2 · Forfatter: Glenn Jarzomkowski · Licens: MIT**
...
1. Hent `bridge-for-i-0.9.2.vsix` fra
   [GitHub Releases](https://github.com/jarzom-ibmi/bridge-for-ibm-i/releases).
...
|---|---|
| Intet sker ved Ctrl+S | Siger første loglinje v0.9.2? Ældre versioner manglede gem-lytteren. |
