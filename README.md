...
**Version 0.10.0 · Author: Glenn Jarzomkowski · License: MIT**
...
4. Verify: **View → Output → "IBM i Bridge"** — the first line must read
   `Bridge for IBM i v0.10.0 active.`
...
|---|---|
| Nothing happens on Ctrl+S | Is the first log line v0.10.0? Older versions lacked the save hook. |
...
**Version 0.10.0 · Forfatter: Glenn Jarzomkowski · Licens: MIT**
...
1. Hent `bridge-for-i-0.10.0.vsix` fra
   [GitHub Releases](https://github.com/jarzom-ibmi/bridge-for-ibm-i/releases).
...
4. Verificér: **View → Output → "IBM i Bridge"** — første linje skal sige
   `Bridge for IBM i v0.10.0 aktiv.`
...
|---|---|
| Intet sker ved Ctrl+S | Siger første loglinje v0.10.0? Ældre versioner manglede gem-lytteren. |
